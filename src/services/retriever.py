...
def search_for_products(query_text: str, top_k=3) -> List[dict]:
    logging.info("RETRIEVER::start - Searching for similar products from vector store")
    ...
    logging.info("RETRIEVER::end - Searching for similar products from vector store")
    return payloads
